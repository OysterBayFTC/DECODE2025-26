...
@Autonomous(name = "RedBackPickUp", group = "OB")
public class RedBackPickUp extends LinearOpMode {
    ...
    private static final Pose2d PICKUP_3     = new Pose2d(26.6, -14.0, Math.toRadians(90));
