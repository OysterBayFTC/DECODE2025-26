...
@Autonomous(name = "AutonRed", group = "OB")
public class botAutonomousRed extends LinearOpMode {
    ...
    private static final Pose2d PICKUP_2 = new Pose2d(-58.7, -34.5, Math.toRadians(140));
    private static final Pose2d PICKUP_END_2 = new Pose2d(-41.5, -47.6, Math.toRadians(140));
    ...
    private void movingBack() {
        ...
        servoTrapLeft.setPower(0.3);
        servoTrapRight.setPower(-0.3);
        sleep(200);
